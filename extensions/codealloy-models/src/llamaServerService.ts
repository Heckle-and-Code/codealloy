...
export class LlamaServerService {
	private static instance: LlamaServerService;
	private process?: ChildProcess;
	private currentModel?: string;
	private currentPort = 51434;
	...
	public static getInstance(): LlamaServerService {
	...
	public getPlatformReleaseAsset(tag = 'b10798'): { url: string; format: 'tar.gz' | 'zip' } | undefined {
	...
	public async start(modelPath: string, port = 51434): Promise<boolean> {
